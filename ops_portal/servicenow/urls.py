...
urlpatterns = [
    ...
    path("change-intake/config/",
         change_intake_pages.change_intake_config_page,
         name="change-intake-config-page"),
    path("change-intake/config/<str:vendor_slug>/save/",
         change_intake_pages.change_intake_config_save,
         name="change-intake-config-save"),
    ...
    path("change-intake/<int:intake_id>/extract/run/",
         change_intake_pages.change_intake_extract_run,
         name="change-intake-extract-run"),
    path("change-intake/<int:intake_id>/extract/poll/<str:task_id>/",
         change_intake_pages.change_intake_extract_poll,
         name="change-intake-extract-poll"),
