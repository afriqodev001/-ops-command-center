...
urlpatterns = [
    ...
    path("change-intake/templates/",
         change_intake_pages.change_intake_template_list,
         name="change-intake-template-list"),
    path("change-intake/templates/<str:vendor_slug>/",
         change_intake_pages.change_intake_template_edit,
         name="change-intake-template-edit"),
    path("change-intake/templates/<str:vendor_slug>/save/",
         change_intake_pages.change_intake_template_save,
         name="change-intake-template-save"),
    path("change-intake/templates/<str:vendor_slug>/reset/",
         change_intake_pages.change_intake_template_reset,
         name="change-intake-template-reset"),
    path("change-intake/templates/<str:vendor_slug>/preview/",
         change_intake_pages.change_intake_template_preview,
         name="change-intake-template-preview"),
