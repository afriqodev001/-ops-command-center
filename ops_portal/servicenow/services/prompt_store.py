...
DEFAULTS: Dict[str, Dict[str, str]] = {
    ...
    'oncall_matrix_format': {
        ...
        'prompt': (
            ...
            "  notes:               FREE TEXT — optional description / context for the row\n"
            ...
            "  notification_id:     reference ID string (free form)\n"
            "  basemon_rule_id:     Basemon rule reference ID string (free form)\n"
            "  outage_guidelines:   FREE TEXT — things to watch out for during the change.\n"
            "  banner:              boolean (true/false)\n"
            "  banner_message:      optional banner notes string\n\n"
